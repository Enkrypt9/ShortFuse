...
public class MenuScaler : MonoBehaviour
{
    ...
    void Start()
    {
        try
        {
            originalPosX = gameObject.GetComponent<RectTransform>().position.x;
            originalPosY = gameObject.GetComponent<RectTransform>().position.y;
        }
        catch
        {
    ...
    void Scale()
    {
        ...
        try
        {
            gameObject.GetComponent<RectTransform>().position = new Vector3(Xratio, Yratio);
